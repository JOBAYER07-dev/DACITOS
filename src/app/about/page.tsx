import { Target, ShieldCheck, Users, TrendingUp, CheckCircle2 } from "lucide-react";
import Link from "next/link";
import Reveal from "@/components/Reveal";

const values = [
  { icon: Target, title: "Innovation First", desc: "We reach for the right modern approach, not the familiar one, to solve real problems." },
  { icon: ShieldCheck, title: "Quality Assurance", desc: "Every release goes through rigorous testing before it reaches your users." },
  { icon: Users, title: "Client-Centric", desc: "We work close enough to understand what success actually looks like for you." },
  { icon: TrendingUp, title: "Continuous Growth", desc: "Our team keeps learning so your systems don't fall behind the curve." },
];
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Reveal>
            ...
            <h1 className="font-display font-semibold text-4xl sm:text-5xl mt-4 leading-tight">
              ...
              <span className="gradient-text"> builds like it&apos;s ours too.</span>
            </h1>
            <p className="mt-6 text-text-secondary text-lg leading-relaxed max-w-2xl mx-auto">
              Dacitos Technologies Private Limited delivers software development,
              cloud infrastructure, and digital transformation for businesses,
              startups, and enterprises — with the accountability of a team that
      ...
      <section className="px-6 py-24">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-start">
          <Reveal>
            <h2 className="font-display text-2xl font-semibold text-text-primary">Our story</h2>
            <p className="mt-4 text-text-secondary leading-relaxed">
              Dacitos was founded on a simple premise: enterprise-grade technology
              shouldn&apos;t be reserved for enterprises. We&apos;ve grown into a
              trusted partner offering managed services, cloud infrastructure, and
              custom software for teams who want a serious build without the
              agency overhead.
            </p>
            <p className="mt-4 text-text-secondary leading-relaxed">
              Every engagement starts the same way — by understanding what you&apos;re
              actually trying to achieve, not just what you asked us to build.
            </p>
          </Reveal>
          <Reveal delay={0.1}>
      ...
      <section className="px-6 py-24 bg-ink-elevated/60 border-y border-border-subtle">
        <div className="max-w-6xl mx-auto">
          <Reveal>
            ...
            <h2 className="font-display text-3xl font-semibold mt-3">Our core values</h2>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="rounded-3xl p-10 bg-gradient-to-br from-cyan/15 to-indigo/15 border border-border-subtle">
              ...
              <p className="mt-3 text-text-secondary text-sm">
                Join the teams who&apos;ve accelerated their roadmap with a partner
                that ships.
              </p>
              <Link
                href="/contact"
